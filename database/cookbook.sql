...
CREATE TABLE `tbl_dish`  (
  ...
  `total_score` decimal(2,1) NOT NULL DEFAULT '0.0' COMMENT '菜谱总评分',
...
CREATE TABLE `tbl_dish_comment`  (
  ...
  `start_count` int NOT NULL DEFAULT '0' COMMENT '评论点赞量',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `create_user` bigint(20) NOT NULL COMMENT '创建人',
  `update_time` datetime NOT NULL COMMENT '修改时间',
  `update_user` bigint(20) NOT NULL COMMENT '修改人',
...
CREATE TABLE `tbl_user`  (
  ...
  `status` int(11) NOT NULL COMMENT '用户状态：1=正常，2=待审核，3=禁用',
...
CREATE TABLE `tbl_user_share`  (
  ...
  `user_id` bigint(20) NOT NULL COMMENT '用户ID',
  `dish_id` bigint(20) NOT NULL COMMENT '菜品ID',
  `img_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '分享图片',
  `description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '分享描述',
  `start_count` int NOT NULL DEFAULT '0' COMMENT '分享点赞量',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `create_user` bigint(20) NOT NULL COMMENT '创建人',
  `update_time` datetime NOT NULL COMMENT '修改时间',
  `update_user` bigint(20) NOT NULL COMMENT '修改人',
